...
%>
<form action="/web/execute_update" method="post">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body" style="padding-top: 12px;">
                    ...
                    <div>
                        ...
                        <input type="text" id="id" readonly name="id" class="form-control inputbox"
                               value="<%=student.getId()%>"/>
                    </div>
                    <div>
                    ...
                    <div>
                        ...
                        <input type="text" id="memo" name="memo" class="form-control inputbox"
                               value="<%=student.getMemo()%>"/>
                    </div>
                    <div style="padding-bottom: 5px;margin-top: 5px"><b>execute params</b></div>
                    <div>
                        <span class="pannel-name">action：</span>
                        <select class="form-control inputbox" name="action" value="">
                ...
                <div class="panel-footer" style="text-align: right;">
                    ...
                    <input class="btn btn-primary btn-padding" type="submit" id="sub"
                           style="width: 120px;"/>
                </div>
            </div>
        </div>
